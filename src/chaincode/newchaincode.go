...
type Car struct {
	...
	cilindrada   int  `json:"cilindrada"`
...
func NewCar( matriculaArg int,   colorArg string,   numPuertasArg int,   cilindradaArg int,   modeloArg int,   marcaArg int,   anoArg int ) *Car {
...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "getAllCilindros" {
		return s.getAllCilindros(APIstub, args)
...
func (s *SmartContract) getAllCilindros(APIstub shim.ChaincodeStubInterface, args[]string) sc.Response {
	/**
	* This is only a template, it is autogenerated.
	*/
